...
function getWeatherIcon(description) {
  ...
  if (desc.includes("cloud")) return <WiCloud size={100} className="text-gray-300 mx-auto" />;
  if (desc.includes("snow")) return <WiSnow size={100} className="text-cyan-300 mx-auto" />;
